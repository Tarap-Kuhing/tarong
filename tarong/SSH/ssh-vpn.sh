...
# install badvpn
cd
wget -O /usr/sbin/badvpn "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/SSH/badvpn" >/dev/null 2>&1
chmod +x /usr/sbin/badvpn > /dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn1.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/SSH/badvpn1.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn2.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/SSH/badvpn2.service" >/dev/null 2>&1
wget -q -O /etc/systemd/system/badvpn3.service "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/SSH/badvpn3.service" >/dev/null 2>&1
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/issue.net"
...
wget -O kuhing "https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/SSH/kuhing.sh"
chmod +x speedtest
chmod +x xp
chmod +x auto-set
chmod +x kuhing
