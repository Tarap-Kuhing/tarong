...
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/slowdns/Installsl.sh && chmod +x Installsl.sh && ./Installsl.sh
clear
#Download Limit
echo -e "${tyblue}.------------------------------------------.${NC}"
...
echo -e "${tyblue}'------------------------------------------'${NC}"
sleep 2
wget https://raw.githubusercontent.com/Tarap-Kuhing/tarong/main/tarong/limit/limit.sh && chmod +x limit.sh && ./limit.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
